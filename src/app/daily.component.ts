...
export class DailyComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      scheduler.parse([
          ...
          { start_date: "2017-06-30 14:00", end_date: "2017-06-30 16:00", text:"Task A-89411", section_id:20},
  
          { start_date: "2017-06-30 10:00", end_date: "2017-06-30 14:00", text:"Task A-64168", section_id:40},
          { start_date: "2017-06-30 16:00", end_date: "2017-06-30 17:00", text:"Task A-46598", section_id:40},
          
          { start_date: "2017-06-30 12:00", end_date: "2017-06-30 14:00", text:"Task B-48865", section_id:50},
          { start_date: "2017-06-30 14:00", end_date: "2017-06-30 16:00", text:"Task B-44864", section_id:50},
          { start_date: "2017-06-30 16:30", end_date: "2017-06-30 18:00", text:"Task B-46558", section_id:50},
          { start_date: "2017-06-30 18:30", end_date: "2017-06-30 20:00", text:"Task B-45564", section_id:50},
          
          { start_date: "2017-06-30 08:00", end_date: "2017-06-30 12:00", text:"Task C-32421", section_id:60},
          { start_date: "2017-06-30 14:30", end_date: "2017-06-30 16:45", text:"Task C-14244", section_id:60},
          
          { start_date: "2017-06-30 09:00", end_date: "2017-06-30 12:00", text:"Task D-52688", section_id:80},
          { start_date: "2017-06-30 12:30", end_date: "2017-06-30 16:30", text:"Task D-46588", section_id:80},
          { start_date: "2017-06-30 12:00", end_date: "2017-06-30 18:00", text:"Task D-12458", section_id:90}
      ],"json");
      ...
      scheduler.attachEvent("onEmptyClick", function (date, e){
          ...
          if(copiedEventDetails === undefined || Object.keys(copiedEventDetails).length === 0) {
              alert("Please copy an activity first");
              return false;
          }
          //paste an event
          scheduler.parse([{
      ...
      function extendShortenActivity(eventId) {
          ...
          scheduler.getEvent(eventId).enableDragAndDrop = true;
      }
