...
module.exports = "<nav>\r\n    <a routerLink=\"/weekly-schedule\">Weekly Schedule</a><br>\r\n    <a routerLink=\"/daily-schedule\">Daily Schedule</a><br>\r\n    <a routerLink=\"/demo-schedule\">Demo Schedule</a>\r\n</nav>\r\n<router-outlet></router-outlet>\r\n"
...
/* harmony import */ var _daily_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./daily.component */ "./src/app/daily.component.ts");
/* harmony import */ var _weekly_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./weekly.component */ "./src/app/weekly.component.ts");
/* harmony import */ var _demo_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./demo.component */ "./src/app/demo.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'weekly-schedule', component: _weekly_component__WEBPACK_IMPORTED_MODULE_5__["WeeklyComponent"] },
    { path: 'daily-schedule', component: _daily_component__WEBPACK_IMPORTED_MODULE_4__["DailyComponent"] },
    { path: 'demo-schedule', component: _demo_component__WEBPACK_IMPORTED_MODULE_6__["DemoComponent"] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _daily_component__WEBPACK_IMPORTED_MODULE_4__["DailyComponent"], _weekly_component__WEBPACK_IMPORTED_MODULE_5__["WeeklyComponent"], _demo_component__WEBPACK_IMPORTED_MODULE_6__["DemoComponent"]
            ],
            imports: [
...
var DailyComponent = /** @class */ (function () {
    ...
    DailyComponent.prototype.ngOnInit = function () {
        ...
        //for laptop/desktop
        jquery__WEBPACK_IMPORTED_MODULE_2__(document).on('mousedown', '.dhx_cal_event_line', function () {
            startTime = new Date().getTime();
        });
        function longPressDetected(e) {
            jquery__WEBPACK_IMPORTED_MODULE_2__('.copyOptionContainer, .copyPasteOverlay').hide();
            ...
            if (longpress) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_2__('.copyOptionContainer, .copyPasteOverlay').show();
                jquery__WEBPACK_IMPORTED_MODULE_2__('.copyOptionContainer').css({ 'left': leftPosition, 'top': topPosition });
                longPressElement = '';
            }
        }
        //display menu on long press for laptop/desktop
        jquery__WEBPACK_IMPORTED_MODULE_2__(document).on('mouseup', '.dhx_cal_event_line', function () {
            longPressDetected(jquery__WEBPACK_IMPORTED_MODULE_2__(this));
        });
        //for iPad
        jquery__WEBPACK_IMPORTED_MODULE_2__('.dhx_cal_event_line').bind("touchstart", function (e) {
            startTime = new Date().getTime();
        });
        jquery__WEBPACK_IMPORTED_MODULE_2__('.dhx_cal_event_line').bind("touchend", function (e) {
            longPressDetected(jquery__WEBPACK_IMPORTED_MODULE_2__(this));
        });
        jquery__WEBPACK_IMPORTED_MODULE_2__('.copyPasteOverlay').on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_2__('.copyOptionContainer, .copyPasteOverlay').hide();
        });
        //function to check user has selected which option
        jquery__WEBPACK_IMPORTED_MODULE_2__('.activityMenuOption').on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_2__('.copyOptionContainer, .copyPasteOverlay').hide();
            var selectedOption = jquery__WEBPACK_IMPORTED_MODULE_2__(this);
        ...
        scheduler.attachEvent("onEmptyClick", function (date, e) {
            var startDate = moment__WEBPACK_IMPORTED_MODULE_1__(date).format("YYYY-MM-DD HH:MM");
            var endDate = moment__WEBPACK_IMPORTED_MODULE_1__(date).add(3, 'hours').format("YYYY-MM-DD HH:MM");
    ...
    ], DailyComponent.prototype, "schedulerContainer", void 0);
...
var DemoComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('scheduler_here'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], DemoComponent.prototype, "schedulerContainer", void 0);
...
var WeeklyComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('weekly_scheduler'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WeeklyComponent.prototype, "schedulerContainer", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\PS52933\Desktop\demo\src\main.ts */"./src/main.ts");
